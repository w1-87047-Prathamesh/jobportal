                            ...
                            <Card className="h-100 shadow-sm">
                                <Card.Body>
                                    ...
                                    <Card.Text>
                                        ...
                                        {job.resume_path ? (
                                            <>
                                                <a href={`${url}/${job.resume_path}`} target="_blank" rel="noopener noreferrer">
                                                    View Resume
                                                </a>
                                                {' | '}
                                                <a href={`${url}/${job.resume_path}`} download>
                                                    Download Resume
                                                </a>
                                            </>
                                        ) : (
                                            <span className="text-danger"> Resume Not Available </span>
                                        )}
                                    </Card.Text>
                                </Card.Body>
                            </Card>
