...
app.post("/", (request, response) => {
    ...
    let queryText = `insert into jobs (provider_id,job_title,job_description,location,category_id,experience_required,salary,companyname,companyimage) values ('${provider_id}','${job_title}','${job_description}','${location}','${category_id}','${experienece_required}','${salary}','${companyname}','${companyimage}')`;
    console.log(queryText);
    let connection = mysql2.createConnection(connectionString);
    connection.connect();
    connection.query(queryText, (err, result) => {
